...
#include "immersedBoundaryMotionFvMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(immersedBoundaryMotionFvMesh, 0);
...
bool Foam::immersedBoundaryMotionFvMesh::update()
{
